...
<div>
    ...
    <div id="pnlSavedVersions" class="resxManager-bottom-item-panel" style="display: none;">
        <br />
        <asp:DropDownList ID="ddlVersions" onchange="setRevertButtonsEnabled(this);" CssClass="resxManager-bottom-item-dropdown" DataTextField="DisplayName" DataValueField="FullPath" runat="server" />
        <br/><br/>
